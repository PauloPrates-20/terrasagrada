...
import { ConsumableItem, RarityStrings } from '../lib/definitions';
...
export default function Consumable({ 
  ...
  clickHandler: (item: ConsumableItem) => void
}) {
  return (
    <li 
    ...
    >
      <p className={`w-3/5 text-start ${rarity}`}>
        <span className='text-titleColor align-middle pr-1'><GiPotionBall size='1.5rem'/></span>
        {item.name}
      </p>
