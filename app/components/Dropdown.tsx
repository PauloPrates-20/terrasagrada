	...
	return (
		<>
			...
			>
				...
				/>
				<div
					className={`flex flex-col absolute left-0 top-4 mt-12 pb-4 bg-barColor w-full sm:w-72 max-h-0 opacity-0 invisible rounded-[0_0_6px_0] transition-all ease-out duration-200 ${display ? 'isChecked' : 'notChecked'}`}
				>
					<a 
						href='/'
